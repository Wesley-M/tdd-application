...
public class CalculatorTest {
    ...
    void whenDevGetSalaryThenSalaryIsRetrieved() {
        ...
        assertEquals(calculator.getSalary(auxDev), auxDev.getBaseSalary() * 0.8);

        // base salary < 3000
        auxDev = new Developer("Wesley Santos", "wesley123@gmail.com", 2000.0);
        assertEquals(calculator.getSalary(auxDev), auxDev.getBaseSalary() * 0.9);
    }
    ...
    void whenDbaGetSalaryThenSalaryIsRetrieved() {
        ...
        assertEquals(calculator.getSalary(auxDba), auxDba.getBaseSalary() * 0.75);

        // base salary < 2000
        auxDba = new Dba("Wesley Santos", "wesley123@gmail.com", 1500.0);
        assertEquals(calculator.getSalary(auxDba), auxDba.getBaseSalary() * 0.85);
    }
    ...
    void whenTesterGetSalaryThenSalaryIsRetrieved() {
        ...
        assertEquals(calculator.getSalary(auxTester), auxTester.getBaseSalary() * 0.75);

        // base salary < 2000
        auxTester = new Tester("Wesley Santos", "wesley123@gmail.com", 1500.0);
        assertEquals(calculator.getSalary(auxTester), auxTester.getBaseSalary() * 0.85);
    }
    ...
    void whenManagerGetSalaryThenSalaryIsRetrieved() {
        ...
        assertEquals(calculator.getSalary(auxManager), auxManager.getBaseSalary() * 0.7);

        // base salary < 5000
        auxManager = new Manager("Wesley Santos", "wesley123@gmail.com", 3500.0);
        assertEquals(calculator.getSalary(auxManager), auxManager.getBaseSalary() * 0.8);
    }
}
